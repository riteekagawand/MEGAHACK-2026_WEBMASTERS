...
export default function PatientDashboard() {
    ...
    return (
        <div className="min-h-screen bg-[#FFFFF4] p-6 relative">
            ...
            >
                <div className="bg-white border-2 border-[#151616] rounded-2xl shadow-[4px_4px_0px_0px_#f9c80e] px-4 py-2 flex items-center gap-2">
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <AnimatePresence>
                    {showCoinAnimation && (
                        ...
                        >
                            <div className="bg-[#f9c80e] text-[#151616] px-6 py-4 rounded-2xl border-2 border-[#151616] shadow-[4px_4px_0px_0px_#151616] flex items-center gap-2">
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                className={`p-4 rounded-xl border-2 border-[#151616] transition-all duration-200 ${task.completed
                                                    ? "bg-[#f9c80e]/20 shadow-[2px_2px_0px_0px_#151616]"
                                                    : "bg-white shadow-[4px_4px_0px_0px_#151616] hover:translate-y-1 hover:shadow-[2px_2px_0px_0px_#151616]"
                                                    }`}
                                            >
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-4">
                                                        <div className={`w-12 h-12 rounded-xl border-2 border-[#151616] flex items-center justify-center ${task.completed ? "bg-[#f9c80e]" : "bg-white"
                                                            }`}>
                                                            {task.completed ? (
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        {!task.completed && (
                                                            <Button
                                                                ...
                                                                className="bg-[#f9c80e] text-[#151616] border-2 border-[#151616] shadow-[2px_2px_0px_0px_#151616] hover:translate-y-0.5 hover:shadow-[1px_1px_0px_0px_#151616] transition-all duration-200 font-poppins font-medium"
                                                            >
                                    ...
                                    {leaderboard.map((user, index) => (
                                        <motion.div
                                            ...
                                            className={`p-3 rounded-xl border-2 border-[#151616] ${user.name === "You"
                                                ? "bg-[#f9c80e]/30 shadow-[2px_2px_0px_0px_#151616]"
