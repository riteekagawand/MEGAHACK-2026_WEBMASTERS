  ...
  return (
    <section className="py-20 bg-[#FFFFF4]">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="bg-white p-8 rounded-2xl border-2 border-[#151616] shadow-[4px_4px_0px_0px_#D6F32F] max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <span className="bg-[#D6F32F] px-4 py-2 rounded-full border-2 border-[#151616] text-[#151616] font-poppins font-medium text-sm">
                Fast Diagnosis
              </span>
              <span className="bg-[#D6F32F] px-4 py-2 rounded-full border-2 border-[#151616] text-[#151616] font-poppins font-medium text-sm">
                Evidence-Based
