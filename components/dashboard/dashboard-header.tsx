        ...
        <header className="h-16 bg-white border-b-2 border-[#151616] shadow-[0px_2px_0px_0px_#151616] flex items-center justify-between px-6">
            ...
            <div className="flex items-center gap-4">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-96 pl-10 pr-4 py-2 border-2 border-[#151616] rounded-xl font-poppins text-sm placeholder:text-[#151616]/60 focus:outline-none focus:ring-0 focus:border-[#f9c80e] transition-colors"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                >
                    ...
                    <div className="absolute -top-1 -right-1 w-3 h-3 bg-[#f9c80e] border border-[#151616] rounded-full"></div>
                </Button>
