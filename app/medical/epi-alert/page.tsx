...
import { Loader2, Map as MapIcon, AlertTriangle, MapPin, ShieldCheck, Activity, Users, Skull, TrendingUp, AlertCircle } from "lucide-react";
...
export default function EpiAlertPage() {
                ...
                {!userLatLng ? (
                  ...
                  nearbyOutbreaks.map((o, idx) => (
                    ...
                    >
                      ...
                      <div className="text-[9px] font-poppins font-medium p-1 rounded"
                        style={{ 
